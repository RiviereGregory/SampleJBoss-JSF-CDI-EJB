...
public class AdresseRegistrationTest {
	...
	@Inject
	AdresseService memberRegistration;
	...
	public void testRegister() throws Exception {
		Adresse newMember = new Adresse();
		newMember.setVille("Marse");
		newMember.setCodePostal(13005);
		newMember.setRue("Chave");
		newMember = memberRegistration.register(newMember);

		log.info("MemberRegistration : " + memberRegistration);

		assertNotNull(newMember.getId());
		log.info(newMember.getVille() + " was persisted with id " + newMember.getId());
	}
