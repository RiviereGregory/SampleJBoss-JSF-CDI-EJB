...
public class MissionRegistrationTest {
	...
	@Inject
	MissionService memberRegistration;
	...
	public void testRegister() throws Exception {
		Mission newMember = new Mission();
		newMember.setNom("Mission Test");
		newMember.setDuree(10);
		newMember.setType(TypeMission.DESIGN.toString());
		newMember = memberRegistration.register(newMember);

		log.info("MemberRegistration : " + memberRegistration);

		assertNotNull(newMember.getId());
		log.info(newMember.getNom() + " was persisted with id " + newMember.getId());
	}
